...
var App = /** @class */function () {
    ...
    App.prototype.checkAnswer = function () {
        ...
        this.appElement.querySelector('#check').addEventListener('click', function (e) {
            ...
            var asnwerjSON = _this.dataStore.lookup(_this.appElement.querySelector('#questionArea').value);
            var str2 = JSON.parse(asnwerjSON);
            var answers = str1.split(' ');
            var resultBool = _this.comparator.compare(answers, str2.meanings);
            var resultString;
            ...
            if (resultBool) objectWeight--;else {
                if (objectWeight <= 9) objectWeight++;
            }
...
var QuestionPick = /** @class */function () {
    ...
    QuestionPick.prototype.prepare = function (dataStore) {
        ...
        for (var i = 1; i < dataStore.getSize(); i++) {
            ...
            if (obj.weight >= 1 && obj.weight <= 3) temp1.push(JSON.stringify(obj));
            if (obj.weight >= 4 && obj.weight <= 6) temp2.push(JSON.stringify(obj));
            if (obj.weight >= 7 && obj.weight <= 9) temp3.push(JSON.stringify(obj));
        }
        var temp = [];
    ...
    QuestionPick.prototype.getQuestion = function (dataStore) {
        ...
        if (this.wordsArray == null || this.wordsArray.length == null || this.wordsArray.length <= 0) return "finished!";
        var str = this.wordsArray.pop();
        var obj = JSON.parse(str);
        var word = obj.word;
        if (word == "undefined") return "undefined";else return word;
    };
    return QuestionPick;
}();
...
app.render();
},{"./App/App":7,"./DataStore/DataStore":8,"./Speech/Speech":9,"./TextToSpeech/TextToSpeech":10,"./Comparator/Comparator":11,"./QuestionPick/QuestionPick":12}],25:[function(require,module,exports) {
...
//# sourceMappingURL=/intern-project.e8f1fbff.map