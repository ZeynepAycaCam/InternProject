...
var App = /** @class */function () {
    ...
    App.prototype.save = function () {
        ...
        this.appElement.querySelector('#save').addEventListener('click', function (e) {
            var emptyArray = [];
            var weightNum;
            var data = { meanings: _this.appElement.querySelector('#meanings').value.split(','),
    ...
    App.prototype.getQuestion = function () {
        ...
        this.appElement.querySelector('#question').addEventListener('click', function (e) {
            var question = _this.dataStore.getWord();
    ...
    App.prototype.questionPickTester = function () {
        ...
        this.appElement.querySelector('#questionPick').addEventListener('click', function (e) {
            ...
            var obj = _this.questionPick.sortByWeight(_this.dataStore);
...
var QuestionPick = /** @class */function () {
    ...
    QuestionPick.prototype.sortByWeight = function (dataStore) {
        var weightArray = [];
        for (var i = 1; i < dataStore.getSize(); i++) {
            var answersString = dataStore.lookupInt(i);
            var answersObjectString = dataStore.lookup(answersString);
            var answersObject = JSON.parse(answersObjectString);
            weightArray.push(answersObject);
        }
        weightArray = weightArray.sort(function (a, b) {
            return a.weight.localeCompare(b.name);
        });
        document.write(weightArray.toString());
        return weightArray;
    };
    QuestionPick.prototype.pickQuestion = function () {};
    return QuestionPick;
}();
...
app.render();
},{"./App/App":3,"./DataStore/DataStore":4,"./Speech/Speech":9,"./TextToSpeech/TextToSpeech":25,"./Comparator/Comparator":18,"./QuestionPick/QuestionPick":8}],9:[function(require,module,exports) {
...
//# sourceMappingURL=/intern-project.84f7a015.map